...
?>
	...
	<table class="shop_table my_account_orders">
		...
		<thead>
			<tr>
				<th class="order-number"><span class="nobr"><?php _e( 'Order', 'rewards' ); ?></span></th>
				<th class="order-date"><span class="nobr"><?php _e( 'Date', 'rewards' ); ?></span></th>
				<th class="order-total"><span class="nobr"><?php _e( 'Earned', 'rewards' ); ?></span></th>
				<th class="order-total"><span class="nobr"><?php _e( 'Used', 'rewards' ); ?></span></th>
				<th class="order-status"><span class="nobr"><?php _e( 'Status', 'rewards' ); ?></span></th>
		...
		<tbody><?php
			foreach ($customer_orders as $customer_order) :
				...
				?><tr class="order">
					...
					<td class="order-status rewards-status" width="1%"><?php _e( $status_name, 'woocommerce' ); ?></td>
