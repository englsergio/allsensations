...
if ( ! class_exists( 'WC_Rewards_Shipping' ) ) :

/**
 * WC_Settings_Shipping
 */
class WC_Rewards_Shipping extends WC_Settings_Page {
	...
	public function get_sections() {
		$sections = array(
			''         => __( 'Rewards Options', 'woocommerce' )
		);
...
return new WC_Rewards_Shipping();
